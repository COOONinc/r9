...
jQuery(function ($) {
  if (document.URL.match(/new_grad/)) {
    $('.menu_sp_menu_container > .menu_wrapper').append('<div class="header_menu header_textmenu menu-item menu-item-type-post_type menu-item-object-page"><a href="https://r09.jp/" class="icon_link" target="_blank"><p>コーポレートサイトはこちら</p><svg class="gaibulink" alt="外部リンク"><use xlink:href="/wp-content/themes/r9/images/gaibulink.svg#gaibulink"></use></svg></a></div>');
  }
  if (document.URL.match(/r9.emposy-server.com/)) {
    $('#sidebar > .category > ul').prepend('<li class="cat-item cat-item-19 sidebar-bg"><a href="https://r9.emposy-server.com/column/">すべて</a></li>');
  }
  ...
  if (document.URL.match(/mid_career/) && window.matchMedia("(max-width: 1000px)").matches) {
    $('#menu-item-506, #menu-item-505, #menu-item-507').wrapAll('<div class=""></div>');
    $('#menu-item-503, #menu-item-504, #sp-mid-career-corp').wrapAll('<div class=""></div>');
    $('.footer_top_menubox').wrapInner('<div class="mid-career-footer-flex"></div>');
  }
  ...
  $(".column_part").each(function () {
    ...
    if (num === 3) {
      $(this).find('.common_part .column_part').css('justify-content', 'space-between');
